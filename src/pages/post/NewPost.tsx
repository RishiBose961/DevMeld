import UseNewPost from "@/components/hook/postHook/UseNewPost";
...
const quotes = [
  "Every line of code you write today builds the developer you become tomorrow.",
  "Great developers aren’t born — they debug, learn, and build every day.",
  "Turn your ideas into code, and your code into impact.",
  "Start with curiosity, continue with practice, and finish with powerful code.",
  "Small commits today create legendary projects tomorrow."
];
...
export default function QuoteBox() {
  ...
  return (
    <div className=" text-lg font-semibold">
      Some Fresh Problem (<span className="text-md font-mono">{quotes[index]}</span>)
